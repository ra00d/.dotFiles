...
local mappings = {
  n = {
    ...
    { lhs = '<leader>e',  rhs = ':Neotree focus  reveal=true<CR>',             opts = options },
    { lhs = '<C-b>',      rhs = ':Neotree toggle reveal=true<CR>',             opts = options },
    { lhs = '<Tab>',      rhs = ':bnext<CR>',                                  opts = options },
    { lhs = '<leader>x',  rhs = ':bd <CR>',                                    opts = options },
    { lhs = '<S-Tab>',    rhs = ':bprev<CR>',                                  opts = options },
    { lhs = '<C-q>',      rhs = ':qa<CR>',                                     opts = options },
    -- TELESCOPE MAPPINGS
    { lhs = '<leader>ff', rhs = ':Telescope find_files<CR>',                   opts = options },
    { lhs = '<leader>fw', rhs = ':Telescope live_grep<CR>',                    opts = options },
    { lhs = '<leader>fb', rhs = ':Telescope buffers<CR>',                      opts = options },
    -- harpoon mappings
    { lhs = '<leader>a',  rhs = ":lua require('harpoon.mark').add_file()<CR>", opts = options },
    -- DBUI MAPPINGS
    {
      lhs = "<leader>tdb",
      rhs = ":DBUIToggle<CR>",
  ...
  i = {
    { lhs = '<C-s>', rhs = '<ESC>:w!<CR>', opts = options },
    { lhs = '<C-q>', rhs = ':qa<CR>',      opts = { desc = "quite all", silent = true } },
    {
      lhs = "<C-x>",
      rhs = function()
